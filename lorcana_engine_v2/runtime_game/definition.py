...
from lorcana_engine_v2.moves.resolve_bag import RESOLVE_BAG, ResolveBagMove
from lorcana_engine_v2.moves.resolve_pending import RESOLVE_EFFECT, ResolveEffectMove
...
lorcana_runtime_config = MatchRuntimeConfig(
    ...
    moves={
        ...
        RESOLVE_BAG: ResolveBagMove(),
        RESOLVE_EFFECT: ResolveEffectMove(),
    },
