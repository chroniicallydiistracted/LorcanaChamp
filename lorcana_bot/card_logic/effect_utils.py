...
EFFECT_KIND_MAP: dict[str, str] = {
    ...
    "return_random_from_inkwell": "return_random_from_inkwell",
    ...
    "put_on_bottom": "put_card_on_bottom",
    ...
    "grant_discard_inkability": "grant_discard_inkability",
    "create-replacement-effect": "create_replacement_effect",
    "create_replacement_effect": "create_replacement_effect",
...
COST_KIND_MAP: dict[str, str] = {
    ...
    "banishself": "banish_self",
    "banish": "banish_self",
    "discard": "discard",
    "discardcards": "discard",
    "discard_cards": "discard",
    "discardchosen": "discard_chosen",
...
TRIGGER_EVENT_MAP: dict[str, str] = {
    ...
    "leave_play": "leave-play",
    "leave-discard": "leave-discard",
